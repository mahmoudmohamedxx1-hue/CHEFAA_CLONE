...
Analyzes and consolidates all collected product data
"""
    ...
    for file_path in data_files:
        if os.path.exists(file_path):
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                # Determine page name and products
                if 'key_points' in data and 'products' in data:
                    # Standard format with products array
                    products = data['products']
                    page_name = data.get('title', 'Unknown')
                elif 'key_points' in data:
                    # Format with key_points containing product objects
...
def generate_comprehensive_report():
    ...
    report = {
        ...
        'key_findings': {
            'most_common_brand': max(summary['brands_found'], key=summary['brands_found'].count) if summary['brands_found'] else 'Unknown',
