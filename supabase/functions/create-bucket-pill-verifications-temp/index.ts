...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'pill-verifications',
        name: 'pill-verifications',
        public: true
    };
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for pill-verifications" ON storage.objects FOR SELECT USING (bucket_id = 'pill-verifications');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for pill-verifications" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'pill-verifications');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for pill-verifications" ON storage.objects FOR UPDATE USING (bucket_id = 'pill-verifications');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for pill-verifications" ON storage.objects FOR DELETE USING (bucket_id = 'pill-verifications');`
    ];
