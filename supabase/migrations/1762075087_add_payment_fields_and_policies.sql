-- Migration: add_payment_fields_and_policies
-- Created at: 1762075087
...
CREATE POLICY IF NOT EXISTS "Allow edge function order updates" ON orders
  FOR UPDATE
...
COMMENT ON COLUMN orders.payment_status IS 'Payment status: pending, paid, failed, canceled';
;