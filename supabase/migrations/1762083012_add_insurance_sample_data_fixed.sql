-- Migration: add_insurance_sample_data_fixed
-- Created at: 1762083012

-- Sample insurance data for Egyptian providers (fixed)

-- Update existing provider to use proper details (skip EG10 as it exists)
...
WHERE provider_code = 'EG10';

-- Add coverage plans for Egyptian providers (excluding existing EG10)
